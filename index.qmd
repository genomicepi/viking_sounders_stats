...
fall_losses <- sum(fall_season_games$Result == "Loss")
fall_ties <- sum(fall_season_games$Result == "Tie")
...
cat('<div class="modal fade" id="gameDetailsModal" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Game Details</h5></div><div class="modal-body"><div id="gameDetailsContent"></div></div></div></div></div>')
```